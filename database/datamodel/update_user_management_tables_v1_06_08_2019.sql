...
SHOW WARNINGS;
CREATE UNIQUE INDEX `address_type_id_UNIQUE` ON `address_type` (`address_type_id` ASC);
...
CREATE TABLE IF NOT EXISTS `address` (
  ...
  CONSTRAINT `address_type_id_fk`
    FOREIGN KEY (`address_type_id_fk`)
...
SHOW WARNINGS;
CREATE INDEX `address_type_id_fk_idx` ON `address` (`address_type_id_fk` ASC);
...
SHOW WARNINGS;
CREATE UNIQUE INDEX `user_address_id_UNIQUE` ON `user_address` (`user_address_id` ASC);

SHOW WARNINGS;
CREATE INDEX `address_id_fk_idx` ON `user_address` (`address_id_fk` ASC);

SHOW WARNINGS;
CREATE INDEX `user_id_fk_idx` ON `user_address` (`user_id_fk` ASC);
...
CREATE TABLE IF NOT EXISTS `login_history` (
  ...
  `login_id_fk` INT NULL,
  PRIMARY KEY (`login_history_id`),
  CONSTRAINT `login_id_fk`
    FOREIGN KEY (`login_id_fk`)
...
SHOW WARNINGS;
CREATE UNIQUE INDEX `login_history_id_UNIQUE` ON `login_history` (`login_history_id` ASC);

SHOW WARNINGS;
CREATE INDEX `login_id_fk_idx` ON `login_history` (`login_id_fk` ASC);
